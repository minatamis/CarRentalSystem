...
public abstract class CarRentalSystem extends JFrame implements ActionListener
{
    ...
    submitInfoButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String userNumber = userNumberTextField.getText();
                String userAddress = userAddressTextField.getText();
                
                UserInfo ui = new UserInfo(userName, userAge, userEmail, userNumber, userAddress);
                ui.setVisible(true);
            }
    });
    }
